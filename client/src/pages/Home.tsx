...
import fadeInAnimationsVariants from '../animations/fadeInAnimationVariants';
      ...
      <section className="w-[90%] flex justify-center items-center flex-wrap gap-10 p-[20px] mt-[80px] max-sm:mt-[100px] max-lg:flex-col">
        <div className='flex-1 flex flex-col justify-between gap-[40px]'>
          ...
          <div className='flex flex-col gap-[15px]'>
            <motion.div variants={fadeInAnimationsVariants} initial="initial" whileInView="animate">
...
const Section4 = () => {
  return (
    <section className="w-[100%] flex justify-center items-center flex-wrap mt-[80px] gap-[50px] bg-Gray py-[50px]">
      <motion.div variants={fadeInAnimationsVariants} initial="initial" whileInView="animate" className='w-[50%] flex flex-col items-center gap-[20px] max-sm:w-[90%]'>
