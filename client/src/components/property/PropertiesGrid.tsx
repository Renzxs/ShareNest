...
const PropertiesGrid = ({properties_data}:PropertiesGrid) => {
    return (
      <div className='flex justify-center flex-row items-center max-sm:flex-col flex-wrap gap-[10px]'>

        {
          properties_data.map((property, index) => (
            <Link key={index} to={property.hreflink}>
              <div className="w-[430px] h-[300px]  max-sm:w-full overflow-hidden rounded-[20px]">
